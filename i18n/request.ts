...
const NAMESPACES = ['common', 'home', 'pricing', 'about', 'contact', 'tools', 'video-tools', 'text-to-video', 'image-to-video', 'ai-video-effects', 'text-to-image', 'image-to-image', 'veo3', 'sora2', 'kling3', 'studio'];
