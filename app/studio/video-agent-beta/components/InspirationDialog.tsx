      ...
      >
        ...
        <div className="px-6 py-3 border-b border-white/10 flex-shrink-0">
          <div className="flex items-center gap-3">
            <div className="px-3 h-10 rounded-lg bg-gradient-to-br from-purple-500/20 to-blue-500/20 flex items-center justify-center flex-shrink-0">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 15 16" fill="none" className="opacity-90">
        ...
        <div className="flex gap-3 p-6 border-t border-white/10 flex-shrink-0">
          ...
          <Button
            ...
            className={cn(
              "flex-1 h-14 text-white text-base font-bold transition-all duration-300",
              selectedIndex === null
