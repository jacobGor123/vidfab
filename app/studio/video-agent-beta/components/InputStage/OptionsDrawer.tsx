    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/5">
          <h3 className="text-lg font-semibold text-white">{t('storyToVideo.options')}</h3>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-6 space-y-6">
          ...
          {/* Duration */}
          <div className="space-y-3">
            <label className="text-sm font-medium text-white/70">{t('storyToVideo.duration')}</label>
          ...
          {/* Background Music */}
          <div className="space-y-3">
            <label className="text-sm font-medium text-white/70">{t('storyToVideo.backgroundMusic')}</label>
            <button
            ...
            >
              <span className="text-sm font-medium text-white">
                {muteBgm ? t('storyToVideo.muted') : t('storyToVideo.enabled')}
              </span>
              {muteBgm ? (
          ...
          <div className="space-y-3 pt-2 border-t border-white/5">
            <label className="text-sm font-medium text-white/70">{t('storyToVideo.aiTools')}</label>
            ...
            >
              {isGeneratingInspiration ? (
                <>
                  ...
                  <span>{t('storyToVideo.generating')}</span>
                </>
              ) : (
                <>
